...
import { PlaylistWhereInput } from '../playlist/playlist-where.input';
import { Type } from 'class-transformer';
import { PlaylistOrderByWithRelationInput } from '../playlist/playlist-order-by-with-relation.input';
import { PlaylistWhereUniqueInput } from '../playlist/playlist-where-unique.input';
import { Int } from '@nestjs/graphql';
import { PlaylistScalarFieldEnum } from '../playlist/playlist-scalar-field.enum';
