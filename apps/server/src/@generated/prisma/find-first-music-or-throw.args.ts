...
import { MusicWhereInput } from '../music/music-where.input';
import { Type } from 'class-transformer';
import { MusicOrderByWithRelationInput } from '../music/music-order-by-with-relation.input';
import { MusicWhereUniqueInput } from '../music/music-where-unique.input';
import { Int } from '@nestjs/graphql';
import { MusicScalarFieldEnum } from '../music/music-scalar-field.enum';
