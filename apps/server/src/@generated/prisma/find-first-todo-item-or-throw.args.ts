...
import { TodoItemWhereInput } from '../todo-item/todo-item-where.input';
import { Type } from 'class-transformer';
import { TodoItemOrderByWithRelationInput } from '../todo-item/todo-item-order-by-with-relation.input';
import { TodoItemWhereUniqueInput } from '../todo-item/todo-item-where-unique.input';
import { Int } from '@nestjs/graphql';
import { TodoItemScalarFieldEnum } from '../todo-item/todo-item-scalar-field.enum';

@ArgsType()
export class FindFirstTodoItemOrThrowArgs {
